...
**真源仓库**：`https://github.com/MapleTraveler/MapleFramework.git`。仓库根即包根，含 `package.json`（`com.maple.framework`）、`README.md`、`CHANGELOG.md`、`LICENSE.md`。当前版本 **1.3.0**，`version` 与 tag `vX.Y.Z` 恒等。
